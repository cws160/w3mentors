            ...
            <div class="col-sm-auto">
                <div class="buttons-group d-flex align-items-center gap-2">
                    ...
                    <?php if ($siteUserType == User::LEARNER) { ?>
                        ...
                        <div class="form-check btn btn--checkbox ps-5">
                            <input id="flexCheckDefault" class="form-check-input" type="checkbox" name="user_autorenew_subscription" value="1" <?php echo ($autoRenew == 1) ? 'checked="checked"' : ''; ?> onclick="autoRenew(this.checked)" />
