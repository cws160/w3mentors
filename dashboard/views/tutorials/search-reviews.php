        ...
        foreach ($reviews as $review) { ?>
            <div class="review">
                <div class="review__media">
                    <div class="avtar avtar--md avtar--round" data-title="<?php echo strtoupper($review['user_first_name'][0]); ?>">
...
<div class="pagination pagination--centered mt-5 reviewSrchListJs">
    <?php
    $pagingArr = [
        'page' => $post['pageno'],
        'pageSize' => $pagesize,
