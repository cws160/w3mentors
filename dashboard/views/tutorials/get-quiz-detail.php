    ...
    <div class="col-xl-12">
        <div class="cms-container">
            <div class="iframe-content editorContentJs">
                <iframe onload="resetIframe(this);" src="<?php echo MyUtility::makeUrl('UserQuiz', 'frame', [$quizLinkId]); ?>" style="border:none; width:100%; height:30px;"></iframe>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="row justify-content-between">
        ...
        <div class="col-sm-auto">
            <div class="btn-actions">
                <a href="javascript:void(0);" last-record='0' class="btn btn--primary-bordered me-1" onclick="loadLecture('<?php echo $lectureId ?>');">
