                ...
                <table style="width: 100%;">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="font-weight: 900;"><?php echo isset($pmethods[$order['order_pmethod_id']]) ? CommonHelper::renderHtml($pmethods[$order['order_pmethod_id']]) : Label::getLabel('LBL_NA'); ?></td>
                        </tr>
                    </tbody>
                </table>
            </td>
