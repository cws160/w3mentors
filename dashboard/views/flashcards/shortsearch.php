    ...
    <div class="flashcard-cover">
        <div class="flash-card">
            <?php foreach ($cards as $card) { ?>
                <div class="flash-card__item pb-3">
                    <h6 class="flash-card-title bold-700"><?php echo $card['flashcard_title']; ?></h6>
                    <p> <?php echo nl2br($card['flashcard_detail']); ?></p>
                    <div class="actions-group">
                        <a href="javascript:void(0);" onclick="flashcardForm(<?php echo $card['flashcard_id']; ?>)" class="btn btn--equal color-black m-1 is-hover">
                        ...
                        <a href="javascript:void(0);" onclick="flashcardRemove('<?php echo $card['flashcard_id']; ?>');" class="btn btn--equal color-black m-1 is-hover">
                            <svg class="icon icon--issue icon--small">
