                    ...
                    <ul>
                        ...
                        <?php foreach ($courses['categories'] as $id => $category) { ?>
                            <?php if (isset($courses['courses'][$id]) && count($courses['courses'][$id]) > 0) { ?>
                                ...
                                <li>
                                    <button onclick="switchCourseCat(this)" href="#inline-content-c<?php echo $id ?>" class="inline-tabs-link <?php echo ($i == 1) ? 'is-active' : ''; ?>">
                        ...
                        <?php if (count($cateCourses) > 0) { ?>
                            <div id="inline-content-c<?php echo $cateId ?>" class="inline-content <?php echo ($i == 1) ? 'visible' : ''; ?>">
                                ...
                                <div class="align-center inline-cta" data-aos="fade-up" data-aos-duration="1000">
                                    <a href="<?php echo MyUtility::makeUrl('Courses') . '?catg=' . $cateId; ?>" class="text-button">
                                        <?php
