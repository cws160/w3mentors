...
<?php foreach ($reviews as $review) { ?>
    <div class="review-row">
        <div class="review-profile">
            <div class="avtar avtar--md avtar--round">
                <img src="<?php echo FatCache::getCachedUrl(MyUtility::makeUrl('Image', 'show', [Afile::TYPE_USER_PROFILE_IMAGE, $review['ratrev_user_id'], Afile::SIZE_SMALL]), CONF_IMG_CACHE_TIME); ?>" alt="<?php echo $review['user_first_name']; ?>" />
            </div>
            <div class="user-info">
...
<?php if ($postedData['pageno'] < $pageCount) { ?>
    ...
    <div class="reviews-wrapper__foot show-more-container">
        <button class="btn btn--grey btn--block btn--show" onclick="loadReviews(<?php echo $postedData['teacher_id']; ?>,<?php echo $nextPage; ?>)"><?php echo Label::getLabel('Lbl_SHOW_MORE'); ?></button>
    </div>
<?php } ?>