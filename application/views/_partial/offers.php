...
?>
<div class="offers-ui">
    <span class="offers-ui__trigger offers-trigger-js" onclick="toggleOffers();">
        <svg class="icon icon--offers icon--small" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 392.11 408.86">
            <g />
            <g>
                <g>
                    <g>
    ...
    <div class="offers-ui__target offers-target-js">
        <a href="javascript:void(0);" class="btn-close" onclick="toggleOffers();"></a>
        <div class="offers-box__group">
            <?php foreach ($offers as $duration => $offer) { ?>
                <span class="offers-box__item">
                    ...
                    <span class="offers-box__item-label"><?php echo str_replace(['{duration}', '{percentages}'], [$duration, number_format(round($offer, 2), 2, '.', '')], $offerPriceLabel); ?></span>
                </span>
            <?php } ?>
        </div>
    </div>
