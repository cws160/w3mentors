            ...
            <div class="calendar-timeslots" style="display:flex;">
                <?php foreach ($slots['slots'] as $key => $slot) { ?>
                    <label class="radio-option">
                        <input type="checkbox" onclick="selectScheduledSlot(this);" name="slots[]" value="<?php echo $slot['start']; ?>">
...
<?php } ?>
<script>
    var labelToSchedule = '<?php echo CommonHelper::htmlEntitiesDecode(Label::getLabel('LBL_LESSONS_TO_SCHEDULE')); ?>';
</script>