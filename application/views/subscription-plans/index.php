...
<section class="section bg-gradiant section--page-header text-center">
    <div class="container container--xl">
        ...
        <p class="p-large mt-3"> <?php echo Label::getLabel('MSG_SUBSCRIPTION_INFO'); ?></p>
    </div>
</section>
                ...
                <div class="packages">
                    <?php foreach ($subscriptionPlans as $plan) { ?>
                        ...
                        if (!empty($activePlan) && $plan['subplan_id'] == $activePlan['ordsplan_plan_id']) {
                            $cls = 'package-card--highlight';
                        } ?>

                        <div class="package-card <?php echo $cls; ?>">
                            <div class="package-card__head">
                                <div class="package-title"> <?php echo $plan['plan_name']; ?></div>
                                <div class="price">
                                    <?php $currSymbol = MyUtility::getCurrencySymbol(); ?>
                                    <sup class="price__currency"><?php echo $currSymbol; ?></sup>
                                    <span class="price__value"><?php echo str_replace($currSymbol, '', MyUtility::formatMoney($plan['subplan_price'])); ?></span>
                                </div>
                            </div>
                            ...
                            <div class="package-card__footer">
                                ...
                                <?php } else { ?>
                                    <button onclick="cart.addSubscriptionPlan('<?php echo $plan['subplan_id'] ?>');" class="btn btn--primary-bordered btn--block btn--lg">
